...
local merge_lists = require("utils.merge_lists")
...
M.default_keybinds = {
	...
	{ key = "y", mods = "CTRL|SHIFT", action = act({ ScrollByPage = -1 }) },
	{ key = "e", mods = "CTRL|SHIFT", action = act({ ScrollByPage = 1 }) },
...
function M.create_keybinds()
	return merge_lists(M.default_keybinds, M.my_keybinds)
end
...
return {
   ...
   keys = M.create_keybinds(),
   key_tables = M.key_tables,
   mouse_bindings = M.mouse_bindings,
}
